...
help_message = "Список команд для бота:\n" \
               ...
               "Content Aware Scale(Жмыхать фотки): /cas <коэфициент>(по стандарту 30)\n" \
               "High Contrast(Высокая контрастность): /contrast <коэфициент>(по стандарту 100)\n" \
               "Эффект \"Вихрь\": /swirl <коэфициент>(по стандарту 90)\n" \
               "Эффект \"Волна\": /wave <Амплитуда волны> <Размер волны> (по стандарту 30 и 90)\n" \
